 ...
 * 还款日当天10：00
 */
public class EmailTemplate4 {
    public static String getHtml4(EmailTemplateEntity emailTemplateEntity, String boletoUrl){
        ...
        sb.append(", informamos que venceu o prazo de pagamento do seu empréstimo. Recomendamos que realize o pagamento o mais rápido possível para assim evitar o acúmulo de moras por atraso de 60% ao mêse negativação do seu CPF no SPC.");
        ...
        sb.append("<label style=\"float:left;font-size:15px;font-family:HKGrotesk-Medium;font-weight:500;color:rgba(130,129,129,1)line-height:23px;\">");
        // 逾期天数
        sb.append("Dia de atraso");
        sb.append("</label><p style=\"float:right;font-size:15px;font-family:HKGrotesk-Medium;font-weight:500;color:rgba(88,88,88,1);line-height:23px;margin:0;padding:0;border:none;\">");
        sb.append(emailTemplateEntity.getOverDueDays()==1?emailTemplateEntity.getOverDueDays()+" dia":emailTemplateEntity.getOverDueDays()+" dias");
    ...
    public static String getSubject4(String appName) {
        String subject = "O seu empréstimo em APPNAME já venceu o prazo";
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getHtml4(temp,"http://asdhad.com"));
    }
}

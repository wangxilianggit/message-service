 ...
 * 还款日当天10：00
 */
public class EmailTemplate7 {
    public static String getHtml7(EmailTemplateEntity emailTemplateEntity, String boletoUrl){
        ...
        sb.append(". Realize o pagamento para evitar acúmulo de moras por atraso de 60% ao mês e risco de negativação do seu CPF no SPC.");
    ...
    public static String getSubject7(String appName) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getHtml7(temp,"http://asdhad.com"));
    }
}
